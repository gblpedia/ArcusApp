...
public class StompClient {
    ...
    public void connect() throws InterruptedException, TimeoutException, StompException, SSLException, UnresolvedAddressException {
        connect( DEFAULT_CONNECT_WAIT_TIME );
    }

    public void connect(long waitTime) throws InterruptedException, TimeoutException, StompException, SSLException, UnresolvedAddressException {
